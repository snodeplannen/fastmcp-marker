...
async def test_simple_conversion() -> bool:
    ...
    try:
        ...
        markdown_text = await convert_pdf_to_markdown(test_pdf_path)
...
async def test_multiple_pdfs() -> bool:
    ...
    test_files = []
    test_pdf1 = '../testfiles/test_document.pdf'
    test_pdf2 = '../testfiles/testdocument2.pdf'
    
    if os.path.exists(test_pdf1):
        test_files.append(test_pdf1)
    if os.path.exists(test_pdf2):
        test_files.append(test_pdf2)
